...
{{--                        <img src="{{asset('assets/dist/img/avatar5.png')}}" class="img-circle" width="45" height="45" alt="user"></a>--}}
                     @if(Auth::user())
                      <img class="img-circle" width="45" height="45" src="{{ Auth::user()->hasPicture() ? asset(Auth::user()->getPicture()) : Auth::user()->getGravatar()}}" alt="User Image"/>
                     @endif
                    <ul class="dropdown-menu" >
                        <li>
                            @if(Auth::user())
                            <a href="{{route('profile' , ['user'=>Auth::user()->id,'name'=>Auth::user()->name])}}">
